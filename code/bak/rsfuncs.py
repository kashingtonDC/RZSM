...
def load_data():
	...
	data['modis_lai'] = [ee.ImageCollection('MODIS/006/MCD15A3H'), "Lai",  0.1, 500] 
	
	data['l8_b1'] = [ee.ImageCollection('LANDSAT/LC08/C01/T1_SR'), "B1" ,  0.001, 30] 
	data['l8_ndvi'] = [ee.ImageCollection("LANDSAT/LC08/C01/T1_8DAY_NDVI"), "NDVI", 1, 30]
